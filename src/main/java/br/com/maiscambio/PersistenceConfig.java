...
@EnableJpaRepositories(basePackages = "${scan.repositoryPackage}", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
public class PersistenceConfig
{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory()
    {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(environment.getProperty("scan.entityPackage"));
