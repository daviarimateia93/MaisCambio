...
public class RepositoryQuery<T>
{
    ...
    public static <T> RepositoryQuery<T> getFromRequest(Class<T> type, HttpServletRequest request)
    {
        ...
        String starterIndexParameter = ControllerHelper.getParameter(REPOSITORY_QUERY_STARTER_INDEX_PARAMETER, request);
        String endIndexParameter = ControllerHelper.getParameter(REPOSITORY_QUERY_END_INDEX_PARAMETER, request);
        ...
        String[] filtersLines = ControllerHelper.getParameterValues(REPOSITORY_QUERY_FILTER_PARAMETER, request);
