...
import me.gerenciar.util.FileHelper;
import me.gerenciar.util.PdfHelper;
...
public class PdfController extends BaseController
{
    ...
    private static final String FILE_NAME_PREFIX = WebMvcConfig.getInstance().getName();
    ...
    {
        File[] files = FileHelper.getFilesFromPath(WebMvcConfig.getInstance().getServletContext(), SLASH + FILE_PATH);
